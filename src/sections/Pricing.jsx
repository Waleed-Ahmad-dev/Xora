               ...
               <Element name='pricing'>
                    <div className="container">
                         <div className="max-w-[960px] pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16 ">
                              ...
                              <div className="relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-s4/25 bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[300px]">
                              ...
                              <div className="pricing-bg">
                                   ...
                                   <img src="/images/bg-outlines-full.png" width={960} height={380} alt="outline" className="absolute inset-0 opacity-5 mix-blend-soft-light"/>
                              </div>
                         </div>
                         {/* Pricing Section */}
                         ...
                         <div className="scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6">
                              {plans.map((plan, index) => (
                                   <div key={plan.id} className="pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]">
                                        ...
                                        <div className={clsx('body-1 relative z-2 mb-10 w-full border-b-s2 pb-6 text-center text-p4', index === 1 && 'border-b')}>
                                             {plan.caption}
                                        </div>
